...
import 'package:darkwallpaperapplication/UI/SetWallpaperPages/ForPopular.dart';
...
class _popularState extends State<Popular> {
  ...
  Future getData() async {
    ...
    QuerySnapshot qn =
    await firestore.collection("popularWallpapers").getDocuments();
    return qn.documents;
  }
                        ...
                        child: GestureDetector(
                          ...
                          onTap: (){
                            Navigator.push(context, CupertinoPageRoute(
                                builder: (context)=>ForPopular(image: image,)
                            ),);
                          },
                        ),
                      );
