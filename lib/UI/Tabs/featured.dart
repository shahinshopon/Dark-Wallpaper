...
import 'package:darkwallpaperapplication/UI/SetWallpaperPages/ForFeatured.dart';
...
class _FeaturedState extends State<Featured> {
  ...
  Future getData() async {
    ...
    QuerySnapshot qn =
    await firestore.collection("featuredWallpapers").getDocuments();
    return qn.documents;
  }
                        ...
                        child: GestureDetector(
                          ...
                          onTap: (){
                            Navigator.push(context, CupertinoPageRoute(
                                builder: (context)=>ForFeatured(image: image,)
                            ),);
                          },
                        ),
                      );
