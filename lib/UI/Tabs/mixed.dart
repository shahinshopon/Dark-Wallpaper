...
import 'package:darkwallpaperapplication/UI/SetWallpaperPages/ForMixed.dart';
...
class _MixedState extends State<Mixed> {
  ...
  Future getData() async {
    ...
    QuerySnapshot qn =
    await firestore.collection("mixedWallpapers").getDocuments();
    return qn.documents;
  }
                        ...
                        child: GestureDetector(
                          ...
                          onTap: (){
                            Navigator.push(context, CupertinoPageRoute(
                                builder: (context)=>ForMixed(image: image,)
                            ),);
                          },
                        ),
                      );
