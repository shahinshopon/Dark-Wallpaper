import 'package:darkwallpaperapplication/UI/SetWallpaperPages/ForRecent.dart';
...
class _RecentState extends State<Recent> {
  ...
  Future getData() async {
    ...
    QuerySnapshot qn =
    await firestore.collection("recentWallpapers").getDocuments();
    return qn.documents;
  }
                        ...
                        child: GestureDetector(
                          ...
                          onTap: (){
                            Navigator.push(context, CupertinoPageRoute(
                                builder: (context)=>ForRecent(image: image,)
                            ),);
                          },
                        ),
                      );
