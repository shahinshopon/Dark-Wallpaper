...
class ForMostViewed extends StatefulWidget {
  DocumentSnapshot image;
  ForMostViewed({this.image});

  @override
  _ForMostViewedState createState() => _ForMostViewedState();
}

class _ForMostViewedState extends State<ForMostViewed> {
